...
4. You can send a CoAP request to the mbed Client device with the mbed Device Connector API. To do that:
	...
	- Click the URL to create a request. For example: `https://connector-test-sl.dev.mbed.com/endpoints/<MBED_ENDPOINT_NAME>/Test/0/S?sync=true` creates a GET request to the static **/Test/0/S** resource.
